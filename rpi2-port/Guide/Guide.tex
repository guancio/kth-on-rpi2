...
One thing we might be particularly interested in is changing the value of a register. This can be done through the command \texttt{set \$r0 = 0x13}, where you can swap \texttt{r0} for the name of the register you want to change and \texttt{0x13} for another value. Then, execute the command \texttt{c} to continue. When you are finished, execute \texttt{quit}.
