...
{
    {ADDR_TO_PAGE(0x00100000), ADDR_TO_PAGE(0x00500000), MLT_HYPER_RAM, MLF_READABLE | MLF_WRITEABLE 	}, // hypervisor ram for dynamic MMU
    {ADDR_TO_PAGE(0x00500000), ADDR_TO_PAGE(0x00600000), MLT_TRUSTED_RAM , MLF_READABLE | MLF_WRITEABLE }, // trusted ram
